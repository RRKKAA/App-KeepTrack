...
public class tareas extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        tareasListView = view.findViewById(R.id.lista_tareas);
        taskAdapter = new ArrayAdapter<>(requireContext(), android.R.layout.simple_list_item_1, new ArrayList<>());
    ...
    public void onResume() {
        ...
        List<Tarea> tasks = FileHelper.readTasksFromFile(requireContext()); // Read tasks from file
